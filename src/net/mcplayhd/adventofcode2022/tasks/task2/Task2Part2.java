...
public class Task2Part2 extends Task {
    @Override
    public String getResult(String[] input) {
        ...
        for (String line : input) {
            ...
            Move myMove = opponentMove.getMoveFromDesiredResult(Outcome.getFromChar((lineChars[2])));
            assert myMove != null;
    ...
    enum Move {
        ...
        Move getMoveFromDesiredResult(Outcome outcome) {
    ...
    enum Outcome {
        ...
        static Outcome getFromChar(char c) {
            switch (c) {
                case 'X':
                    return LOSS;
                case 'Y':
