...
public class Task9Part2 extends Task {
    ...
    public String getResult(String[] input) {
        ...
        for (String line : input) {
            ...
            for (int n = 0; n < amount; n++) {
                ...
                Loc parent = head;
                for (Loc tail : tails) {
                    moveTail(tail, parent);
                    parent = tail;
                }
                Loc tail = tails[tails.length - 1];
    ...
    void moveTail(Loc tail, Loc parent) {
        Loc delta = tail.difference(parent);
